...
QT_MOC_LITERAL(1, 12, 13), // "bytesReceived"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 4), // "data"
QT_MOC_LITERAL(4, 32, 13), // "linkConnected"
QT_MOC_LITERAL(5, 46, 16), // "linkDisconnected"
QT_MOC_LITERAL(6, 63, 9), // "linkError"
QT_MOC_LITERAL(7, 73, 7) // "message"

    },
    "LinkManager\0bytesReceived\0\0data\0"
    "linkConnected\0linkDisconnected\0linkError\0"
    "message"
};
...
void LinkManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (LinkManager::*)(const QByteArray & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LinkManager::bytesReceived)) {
                *result = 0;
                return;
            }
        }
        ...
        {
            using _t = void (LinkManager::*)(const QString & );
...
// SIGNAL 0
void LinkManager::bytesReceived(const QByteArray & _t1)
{
...
// SIGNAL 1
void LinkManager::linkConnected()
{
...
// SIGNAL 3
void LinkManager::linkError(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
