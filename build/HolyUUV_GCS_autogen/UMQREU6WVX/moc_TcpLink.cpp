...
QT_MOC_LITERAL(1, 8, 11), // "onConnected"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 14), // "onDisconnected"
QT_MOC_LITERAL(4, 36, 11), // "onReadyRead"
QT_MOC_LITERAL(5, 48, 15), // "onErrorOccurred"
QT_MOC_LITERAL(6, 64, 28), // "QAbstractSocket::SocketError"
QT_MOC_LITERAL(7, 93, 5) // "error"

    },
    "TcpLink\0onConnected\0\0onDisconnected\0"
...
QT_INIT_METAOBJECT const QMetaObject TcpLink::staticMetaObject = { {
    QMetaObject::SuperData::link<ILink::staticMetaObject>(),
...
void *TcpLink::qt_metacast(const char *_clname)
{
    ...
    return ILink::qt_metacast(_clname);
}

int TcpLink::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = ILink::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 4)
