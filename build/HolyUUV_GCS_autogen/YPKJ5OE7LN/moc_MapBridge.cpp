...
QT_MOC_LITERAL(5, 46, 11), // "hasPosition"
QT_MOC_LITERAL(6, 58, 13) // "tileCachePath"

    },
    "MapBridge\0positionChanged\0\0latitude\0"
    "longitude\0hasPosition\0tileCachePath"
};
...
void MapBridge::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MapBridge::positionChanged)) {
                *result = 0;
                return;
            }
        }
        ...
        case 2: *reinterpret_cast< bool*>(_v) = _t->hasPosition(); break;
        case 3: *reinterpret_cast< QString*>(_v) = _t->tileCachePath(); break;
        default: break;
        }
...
// SIGNAL 0
void MapBridge::positionChanged()
{
